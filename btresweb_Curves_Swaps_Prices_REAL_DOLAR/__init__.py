...
def CRVBRABMF_PRICE_REAL_X_DOLAR(valores, dia, feriados=list()):
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        # gerando os vértices
        data_frame = CRVBRABMF_PRICE_REAL_X_DOLAR(valores, dia)
        
        # preparando o upload do arquivo
        valores = DictFromDataframe.curvas('CRVBRABMF_PRICE_REAL_X_DOLAR', dia, data_frame)
        container_name="btresweb"
        versionamento = 'REAL_DOLAR_v1'
