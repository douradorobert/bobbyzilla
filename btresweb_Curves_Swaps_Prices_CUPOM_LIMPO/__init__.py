...
def CRVBRABMF_CUPOM_LIMPO(valores, dia, feriados=list()):
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        # gerando os vértices
        data_frame = CRVBRABMF_CUPOM_LIMPO(valores, dia)
        
        # preparando o upload do arquivo
        valores = DictFromDataframe.curvas('CRVBRABMF_CUPOM_LIMPO', dia, data_frame)
        container_name="btresweb"
        versionamento = 'CUPOM_LIMPO_v1'
