...
def CRVBRABMF_RATE_SWAP_SELIC_PRE(valores, dia, feriados=list()):
    ...
    df["value"] =(1+df["value"]/100)**(df["DU"]/252)
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        # gerando os vértices
        data_frame = CRVBRABMF_RATE_SWAP_SELIC_PRE(valores, dia)
        
        # preparando o upload do arquivo
        valores = DictFromDataframe.curvas('CRVBRABMF_RATE_SWAP_SELIC_PRE', dia, data_frame)
        container_name="btresweb"
        versionamento = 'SELIC_PRE_v1'
