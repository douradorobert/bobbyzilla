...
def CRVBRABMF_RATE_SWAP_DI1_IAP(valores, dia, feriados=list()):
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        # gerando os vértices
        data_frame = CRVBRABMF_RATE_SWAP_DI1_IAP(valores, dia)
        
        # preparando o upload do arquivo
        valores = DictFromDataframe.curvas('CRVBRABMF_RATE_SWAP_DI1_IAP', dia, data_frame)
        container_name="btresweb"
        versionamento = 'DI1_IAP_v1'
